// Libs
import { ConfigService, container, HelperService, ParametersType, PromService, RelationModule } from "artos";
...
import { EndTimerDTO, ReportDTO, StartTimerDTO } from "../../shared/dto";
...
export class TimerController {
  ...
  public start(): RequestHandler {
    return (request: Request, response: Response): void => {
      ...
      const startTimer: StartTimerDTO = new StartTimerDTO({
  ...
  public stop(): RequestHandler {
    return (request: Request, response: Response): void => {
      const endTimer: EndTimerDTO = new EndTimerDTO({
        id: request.body.id,
